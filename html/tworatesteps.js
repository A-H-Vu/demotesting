...
psychoJS.start({
  expName: expName,
  expInfo: expInfo,
  resources: [{name: 'taskConds.xlsx', path: './resources/taskConds.xlsx'}, {name: 'famConds.xlsx', path: './resources/famConds.xlsx'}]
  });
...
function trialRoutineBegin(trials) {
  return function () {
    ...
    console.log(taskLoop.thisN + "hi");
    console.log((trialsLoop.thisN % 4) + "hello");
